...
class Zend_Auth_Storage_Session implements Zend_Auth_Storage_Interface
{
	...
	*/
    ...
    public function isEmpty()
    {
		...
		return !$this->_session->userdata($this->_member);
    ...
    public function write($contents)
    {
		...
		$this->_session->set_userdata($this->_member,$contents);
    }
    ...
    public function clear()
    {
		...
		$this->_session->unset_userdata($this->_member);
    }
}
